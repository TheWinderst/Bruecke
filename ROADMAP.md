...
- `LICENSE` (MIT, thewinderst), `.gitignore`, `README` (kaynak atıfları + gizlilik +
...
### Now — sıradaki (en yüksek değer / düşük maliyet)
- **P1 · Kelime tekrar kartları (flashcard) [S]** — Kayıtlı kelimelerden çevir-kapat
  tarzı tekrar. Veri ve puanlama altyapısı zaten var; uygulamayı pasif sözlükten gerçek
  bir **öğrenme döngüsüne** çevirir.
- **P2 · Arama geçmişi [S]** — Yıldızlamadığın kelimeler kaybolmasın; "Son aramalar"
  listesi. Çevrimdışı önbelleğin de temeli.
- **P10 · Örnek cümle seslendirme [S]** — *(1.0'da eklendi ✔)* her örneğin yanında 🔊.

### Next — yakında
- **P3 · Çevrimdışı önbellek [M]** — Daha önce bakılan kelimeler internetsiz de açılsın;
  hız + kırılgan Google ucuna daha az yük.
...
- **P8 · Anki/CSV dışa aktarma [S]** — Kayıtlı kelimeleri Anki'ye taşı + yedek.

### Later — sonra (daha büyük)
- **P4 · Aralıklı tekrar (SRS) [M]** — P1'in üstüne SM-2/Leitner; kalıcı öğrenme.
- **P6 · Türkçe → Almanca yön [M]** — Üretim (yazma/konuşma) için ters arama.
